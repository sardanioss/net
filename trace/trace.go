...
*/
package trace // import "github.com/sardanioss/net/trace"
...
import (
	...
	"github.com/sardanioss/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/sardanioss/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of github.com/sardanioss/net/trace.")
	}
...
var contextKey = contextKeyT("github.com/sardanioss/net/trace.Trace")
